    ...
    <div className="explorer-panel">
      ...
      {!openedFolderPath ? (
        <div className="explorer-content">
          ...
          <button className="action-button" onClick={() => onOpenFile('新项目.txt', 'root/new-project.txt')}>新建项目</button>
        ...
        <div className="explorer-content">
          <div className="explorer-text-group" style={{ wordBreak: 'break-all', fontSize: '12px' }}>
            已打开: {openedFolderPath}
          </div>
          <div className="explorer-list-item" onClick={() => onOpenFile('示例章节.md', `${openedFolderPath}/chapter1.md`)}>
      ...
      <div style={{ marginTop: '20px' }}>
        ...
        <div className="explorer-list-item" onClick={() => onOpenFile('最近项目.log', 'history/recent.log')}>
